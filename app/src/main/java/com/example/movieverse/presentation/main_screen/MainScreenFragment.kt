...
class MainScreenFragment : Fragment() {
    ...
    private lateinit var featuredMoviesViewPagerAdapter: TopMoviesViewPagerAdapter
    ...
    private fun setupViews() {
        ...
        binding.vpTopMoviesViewPager.setPageTransformer(SliderTransformer(offscreenPageLimit = 5))

        featuredMoviesViewPagerAdapter = TopMoviesViewPagerAdapter()
        featuredMoviesViewPagerAdapter.submitList(mutableListOf())
        binding.rvFeaturedMovies.layoutManager = androidx.recyclerview.widget.GridLayoutManager(requireContext(), 2)
